...
def split(data, val_frac=0, test_frac=0.2):
...
if __name__ == "__main__":
    ...
    x_train.to_csv('../data/train_X.csv', header=True, index=False)
    y_train.to_csv('../data/train_y.csv', header=True, index=False)

    # x_val.to_csv('../data/val_X.csv', header=True, index=False)
    # y_val.to_csv('../data/val_y.csv', header=True, index=False)

    x_test.to_csv('../data/test_X.csv', header=True, index=False)
    y_test.to_csv('../data/test_y.csv', header=True, index=False)
