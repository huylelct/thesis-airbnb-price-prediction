...
if __name__ == "__main__":
    ...
    X_val = X_val.drop(columns=["shared_bath"])
    X_test = X_test.drop(columns=["shared_bath"])
    X_train = X_train.drop(columns=["private_bath"])
    X_val = X_val.drop(columns=["private_bath"])
    X_test = X_test.drop(columns=["private_bath"])
